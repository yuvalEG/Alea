...
namespace
{
    ...
    const juce::String aboutText = juce::String::fromUTF8 (
        ...
        "THE EXERCISE\n\n"
        "This app was born from an improvisation exercise idea:\n"
        "generate a short random chord progression, loop it, and improvise over it with your "
        ...
        "CHORDS decides what the dice can roll.\n"
        " LOOP decides how it "
        "sounds.\n"
        "Rolling mid-loop swaps the "
        "new chords in at the next change, and clicking a chord jumps "
        "there.\n"
        "Key lock keeps every roll diatonic.\n\n"
        "MONITOR shows what is sounding. Make the window shorter to "
        "tuck it away and find the chord's notes yourself, a nice "
        "theory workout.\n\n"
        "EAR WORKOUT MODE (press E, or the top-right menu):\n"
        "Hides the chord names, and you name what you hear. Click the eye on a "
      ...
      ticker (p), monitor (p)
{
    ...
    // Every open is 920x726 - the ratio Yuval settled on hands-on (July 10),
    // width-matched to the Scale Shifter. Size is not persisted (family
    // behavior, and persisted sizes kept restoring shutdown transients).
    // Short windows are legitimate within a session: the tucked-monitor
    // practice mode.
    setResizable (true, true);
    setResizeLimits (860, 520, 4096, 2400);
    setSize (920, 726);
