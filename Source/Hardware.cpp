...
namespace hw
{
    ...
    {
        // The July 10 handoff's BAKED matte finish, lifted ~42% total per Yuval
        // (stops premultiplied at x0.92, i.e. metal-l ~0.85), sheen 0.1 (near-
        ...
        else
        {
            ...
            juce::ColourGradient grad (juce::Colour (0xff131417), r.getX(), r.getY(),
                                       juce::Colour (0xff161719), r.getRight(), r.getY() + r.getHeight() * 0.12f, false);
            grad.addColour (0.13, juce::Colour (0xff23262c));
            grad.addColour (0.27, juce::Colour (0xff363c48));
            grad.addColour (0.39, juce::Colour (0xff424b5d));
            grad.addColour (0.51, juce::Colour (0xff23262c));
            grad.addColour (0.64, juce::Colour (0xff373d48));
            grad.addColour (0.75, juce::Colour (0xff3c4351));
            grad.addColour (0.89, juce::Colour (0xff202226));
            g.setGradientFill (grad);
            g.fillRoundedRectangle (r, radius);
        }
        if (! isPlate)
                 ...
                 float diameter)
    {
        ...
        juce::ColourGradient off (juce::Colour (0xff3a3d44), r.getX() + diameter * 0.4f, r.getY() + diameter * 0.35f,
                                  juce::Colour (0xff202226), r.getRight(), r.getBottom(), true);
